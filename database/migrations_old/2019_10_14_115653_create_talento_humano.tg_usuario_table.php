...
class CreateTalentoHumano.tgUsuarioTable extends Migration {
	...
	public function up()
	{
		Schema::create('talento_humano.tg_usuario', function(Blueprint $table)
		{
	...
	{
		Schema::drop('talento_humano.tg_usuario');
	}
