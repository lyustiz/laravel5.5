...
class CreateTalentoHumanoOld.tgUbicacionTable extends Migration {
	...
	public function up()
	{
		Schema::create('talento_humano_old.tg_ubicacion', function(Blueprint $table)
		{
	...
	{
		Schema::drop('talento_humano_old.tg_ubicacion');
	}
