...
class CreateCorpovexVisitas.trBitacoraTable extends Migration {
	...
	public function up()
	{
		Schema::create('corpovex_visitas.tr_bitacora', function(Blueprint $table)
		{
	...
	{
		Schema::drop('corpovex_visitas.tr_bitacora');
	}
